...
### Why does NPS pose problems for statistical analysis?
...
```{r echo = FALSE, comment = ''}
d <- density(brand_a)
ggpplot(d, main="Distribution of Transformed NPS responses") 
abline(h = mean(brand_a)-1.96*(sd(brand_a)/sqrt(length(brand_a))))
