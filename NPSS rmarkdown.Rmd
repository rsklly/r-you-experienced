...
d <- ggplot(data = melted) + aes(x = value, fill = variable, alpha = 0.5) + geom_density() + geom_vline(data = cis, aes(xintercept= vals, color = brand), size=0.5) + geom_text(data = cis, aes(x = vals, label = labels))
